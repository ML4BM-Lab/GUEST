...
You can verify that your splits fulfill the mode requirements after they have been generated.
    ...
    #You can also visualize the distribution by setting distr to True (distr's default: False)
